...
每只股票各 **90 个交易日**，日期范围为 **2026-04-24 至 2026-09-02**，已写入 2026-09-02 行情。
...
14 只股票均滚动保存 **20 个历史交易日 + 最新完整交易日**。每个交易日含 16 根 15 分钟 K 线，每只股票始终保留 336 行；当前区间为 **2026-08-05 至 2026-09-02**，自动任务会随交易日向前滚动。
