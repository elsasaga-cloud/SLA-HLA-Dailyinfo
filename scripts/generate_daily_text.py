...
STOCKS = (
    ...
    Stock(
        code="601600",
        name="中国铝业",
        total_shares=17_154_971_327,
        floating_shares=13_203_339_905,
        book_value_per_share=9.46 / 2.08,
        profit_bases=(ProfitBasis("0000-00-00", 22_109_813_181.66),),
        actions=(),
    ),
    Stock(
        code="601988",
        name="中国银行",
        total_shares=322_212_411_814,
        floating_shares=210_765_514_846,
        book_value_per_share=6.14 / 0.73,
        profit_bases=(ProfitBasis("0000-00-00", 226_619_038_778.69),),
        actions=(),
    ),
    Stock(
        code="600863",
        name="华能蒙电",
        total_shares=7_835_189_560,
        floating_shares=7_063_325_057,
        book_value_per_share=4.74 / 1.94,
        profit_bases=(ProfitBasis("0000-00-00", 2_777_771_018.28),),
        actions=(),
    ),
    Stock(
        code="601138",
        name="工业富联",
        total_shares=19_844_092_284,
        floating_shares=19_844_092_284,
        book_value_per_share=59.73 / 6.74,
        profit_bases=(ProfitBasis("0000-00-00", 47_487_485_261.35),),
        actions=(),
    ),
    Stock(
        code="000651",
        name="格力电器",
        total_shares=5_601_405_741,
        floating_shares=5_522_009_474,
        book_value_per_share=41.63 / 1.53,
        profit_bases=(ProfitBasis("0000-00-00", 24_340_972_964.28),),
        actions=(
            CorporateAction(
                "2026-08-27",
                2.00,
                "现金分红除权；历史价格在该日及以后计算技术指标时前复权 2.00 元",
            ),
        ),
    ),
    Stock(
        code="300124",
        name="汇川技术",
        total_shares=2_707_603_944,
        floating_shares=2_410_314_720,
        book_value_per_share=58.30 / 4.51,
        profit_bases=(ProfitBasis("0000-00-00", 4_053_757_317.29),),
        actions=(),
    ),
    Stock(
        code="600362",
        name="江西铜业",
        total_shares=3_462_729_405,
        floating_shares=2_075_247_405,
        book_value_per_share=45.42 / 1.90,
        profit_bases=(ProfitBasis("0000-00-00", 11_266_272_892.20),),
        actions=(),
    ),
    Stock(
        code="601899",
        name="紫金矿业",
        total_shares=26_590_714_622,
        floating_shares=20_601_793_140,
        book_value_per_share=34.43 / 4.80,
        profit_bases=(ProfitBasis("0000-00-00", 78_316_364_793.45),),
        actions=(),
    ),
    Stock(
        code="300760",
        name="迈瑞医疗",
        total_shares=1_211_799_431,
    ...
    Stock(
        code="002352",
        name="顺丰控股",
        total_shares=5_265_308_078,
        floating_shares=4_799_115_259,
        book_value_per_share=33.04 / 1.77,
        profit_bases=(ProfitBasis("0000-00-00", 10_102_542_328.52),),
        actions=(),
    ),
    Stock(
        code="000807",
        name="云铝股份",
        total_shares=3_467_957_405,
        floating_shares=3_467_921_101,
        book_value_per_share=26.08 / 2.63,
        profit_bases=(ProfitBasis("0000-00-00", 14_401_963_236.05),),
        actions=(),
    ),
    Stock(
        code="600398",
